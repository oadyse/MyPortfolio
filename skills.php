    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
            ...
            <div class="col-lg-6">
                ...
                <div class="progress">
                    <span class="skill">Figma <i class="val">30%</i></span>
                    <div class="progress-bar-wrap">
                ...
                <div class="progress">
                    <span class="skill">React Native <i class="val">30%</i></span>
                    <div class="progress-bar-wrap">
                        <div class="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="progress">
                    <span class="skill">CodeIgniter 3<i class="val">60%</i></span>
                    <div class="progress-bar-wrap">
                        <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
                ...
                <div class="progress">
                    <span class="skill">English Language<i class="val">80%</i></span>
                    <div class="progress-bar-wrap">
